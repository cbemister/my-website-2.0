<template>
  <v-layout row justify-center>
    ...
    <v-btn slot="activator" class="secondary darken-1 pl-5 pr-4" style="height: 80px; -webkit-clip-path: polygon(20% 0%, 100% 0, 100% 100%, 0% 100%); clip-path: polygon(20% 0%, 100% 0, 100% 100%, 0% 100%);" left dark>
